/**
 * Interior Design Services Page - Premium Luxury Edition
 *
 * User-facing page for browsing and booking interior design services
...
const InteriorDesign = () => {
  ...
  // Mock interior design services
  const mockServices = [
    {
      _id: '1',
      title: 'Living Room Design',
      description: 'Transform your living space with our expert interior design. Complete living room makeover including furniture selection, color schemes, lighting design, and decor placement.',
    ...
    },
    {
      ...
      description: 'Create your dream bedroom sanctuary. Complete bedroom design including wardrobe, bed design, lighting, and comfortable ambiance creation.',
      category: 'Residential',
    ...
    },
    {
      ...
      description: 'Functional and beautiful kitchen design. Complete modular kitchen with premium materials, smart storage, appliances integration, and modern aesthetics.',
      category: 'Residential',
    ...
    },
    {
      ...
      description: 'Professional office space design for productivity. Modern office interiors with ergonomic furniture, efficient layouts, and brand-aligned aesthetics.',
      category: 'Office',
    ...
    },
    {
      ...
      description: 'Complete home interior design solution. End-to-end design for entire home including all rooms, coordination, and project management.',
      category: 'Full Home',
    ...
    },
    {
      ...
      description: 'Attractive restaurant and cafe interiors. Design that enhances dining experience with perfect ambiance, seating arrangements, and branding.',
      category: 'Commercial',
  ...
  const handleSubmitBooking = async (e) => {
    ...
    try {
      ...
      console.log('Interior Design Booking:', bookingData)

      // Mock booking success
      const mockBookingId = `INT-${Date.now()}`
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute w-96 h-96 bg-gradient-to-br from-blue-400/30 to-purple-400/30 rounded-full blur-3xl -top-20 -left-20 animate-pulse"></div>
          <div className="absolute w-96 h-96 bg-gradient-to-br from-purple-400/30 to-pink-400/30 rounded-full blur-3xl -bottom-20 -right-20 animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl mb-6 bg-gradient-to-r from-blue-900 via-purple-900 to-pink-900 bg-clip-text text-transparent">
              Transform Your Space
            </h1>
            <p className="font-body text-xl md:text-2xl text-gray-700 mb-10 leading-relaxed">
              Where luxury meets functionality. Experience world-class interior design crafted by expert designers who bring your vision to life.
            </p>
            ...
            >
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden border border-white/20 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="relative h-72 overflow-hidden">
                  ...
                  {/* Category Badge */}
                  <div className="absolute bottom-4 left-4 px-4 py-2 bg-white/95 backdrop-blur-md rounded-full text-sm font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 shadow-lg">
                    {service.category}
                  </div>
                ...
                <div className="p-6 relative z-10">
                  <h3 className="font-heading text-2xl mb-3 bg-gradient-to-r from-blue-900 to-purple-900 bg-clip-text text-transparent group-hover:scale-105 transition-transform origin-left">
                    {service.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between mb-5 pt-5 border-t border-gray-200/50">
                    <div>
                      ...
                      <p className="font-heading text-2xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-3.5 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2 group"
                  >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    {comparisonServices.map(service => (
                      <div key={service._id} className="flex items-center gap-2 px-3 py-1.5 bg-blue-100 rounded-full text-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                  >
                    Compare Services
                  </button>
                </div>
            ...
            >
              <div className="p-8">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="font-heading text-3xl bg-gradient-to-r from-blue-900 to-purple-900 bg-clip-text text-transparent">
                    Compare Services
                  </h2>
                  <button
                    onClick={() => setShowComparisonModal(false)}
                      ...
                      <tr className="border-b-2 border-gray-200">
                        ...
                        {comparisonServices.map(service => (
                          <th key={service._id} className="p-4 text-center">
                            <div className="font-heading text-lg bg-gradient-to-r from-blue-900 to-purple-900 bg-clip-text text-transparent">
                              {service.title}
                            </div>
                      ...
                      <tr className="border-b border-gray-100 bg-gray-50/50">
                        ...
                        {comparisonServices.map(service => (
                          <td key={service._id} className="p-4 text-center">
                            <span className="font-heading text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                              {formatPrice(service.pricing)}
                            </span>
                          </td>
                        ))}
                        ...
                        {comparisonServices.map(service => (
                          <td key={service._id} className="p-4">
                            <button
                              ...
                              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-3 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl"
                            >
                              Book Now
                            </button>
                          </td>
          ...
          >
            ...
            >
              <div className="p-8">
                ...
                {selectedService && (
                  <div className="mb-6 p-5 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-blue-200/50">
                    <h3 className="font-heading text-xl bg-gradient-to-r from-blue-900 to-purple-900 bg-clip-text text-transparent mb-2">
                ...
                <form onSubmit={handleSubmitBooking} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 text-white py-4 rounded-xl font-semibold text-lg transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
        ...
        {showSuccessModal && (
          ...
          >
            ...
            >
              ...
              <h3 className="font-heading text-3xl mb-3 bg-gradient-to-r from-blue-900 to-purple-900 bg-clip-text text-transparent">
                Booking Confirmed!
              </h3>
              <p className="font-body text-gray-600 mb-6 leading-relaxed">
                Your interior design consultation request has been received successfully. Our design team will reach out to you soon!
              </p>

              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-5 mb-6 border border-blue-200/50">
              ...
              <button
                onClick={() => setShowSuccessModal(false)}
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl hover:scale-105"
              >
                Done
              </button>
            </motion.div>
