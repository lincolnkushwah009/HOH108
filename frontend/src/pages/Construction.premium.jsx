 ...
 *
 * User-facing page for browsing and booking construction design services
...
const InteriorDesign = () => {
  ...
  // Mock construction design services
  const mockServices = [
    {
      _id: '1',
      title: 'Living Room Design',
      description: 'Transform your living space with our expert construction design. Complete living room makeover including furniture selection, color schemes, lighting design, and decor placement.',
    ...
    },
    {
      ...
      description: 'Professional office space design for productivity. Modern office constructions with ergonomic furniture, efficient layouts, and brand-aligned aesthetics.',
      category: 'Office',
    ...
    },
    {
      ...
      description: 'Complete home construction design solution. End-to-end design for entire home including all rooms, coordination, and project management.',
      category: 'Full Home',
    ...
    },
    {
      ...
      description: 'Attractive restaurant and cafe constructions. Design that enhances dining experience with perfect ambiance, seating arrangements, and branding.',
      category: 'Commercial',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-red-50">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute w-96 h-96 bg-gradient-to-br from-purple-400/30 to-orange-400/30 rounded-full blur-3xl -bottom-20 -right-20 animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl mb-6 bg-gradient-to-r from-orange-900 via-purple-900 to-orange-900 bg-clip-text text-transparent">
              Build Your Dream
            </h1>
            <p className="font-body text-xl md:text-2xl text-gray-700 mb-10 leading-relaxed">
              Where luxury meets functionality. Experience world-class construction design crafted by expert designers who bring your vision to life.
            </p>
              ...
              <button
                ...
                className={`px-6 py-2.5 rounded-xl font-medium text-sm whitespace-nowrap transition-all duration-300 ${
                  selectedCategory === category
                    ? 'bg-gradient-to-r from-orange-600 to-red-600 text-white shadow-lg shadow-blue-500/50 scale-105'
                  ...
                  <div className="absolute top-4 left-4">
                    <label className="flex items-center gap-2 px-3 py-2 bg-white/95 backdrop-blur-md rounded-full cursor-pointer hover:scale-105 transition-transform shadow-lg">
                      <input
                        ...
                        className="w-4 h-4 text-orange-600 rounded focus:ring-2 focus:ring-blue-500"
          ...
          >
            ...
            >
              <div className="p-8">
                ...
                {selectedService && (
                  <div className="mb-6 p-5 bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl border border-blue-200/50">
          ...
          >
            ...
            >
              ...
              <p className="font-body text-gray-600 mb-6 leading-relaxed">
                Your construction design consultation request has been received successfully. Our design team will reach out to you soon!
              </p>

              <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-5 mb-6 border border-blue-200/50">
